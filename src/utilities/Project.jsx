...
const Project = () => {
  return (
    <div className="flex mr-7 h-full">
      <div className="basis-1/2 w-full rounded bg-red pr-5">
        <img srcSet="/public/images/project1.png" className=" w-full h-full" />
      </div>
      <div className="basis-1/2 flex flex-col gap-1 ">
        <div className="flex justify-between gap-2">
          <h3 className="w-3/4 text-c-white font-semibold ">
